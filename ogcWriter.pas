...
var def_WD: TWriterDesk;
 ...
 Function Fmtln(Params: Array of Const; C:Integer = 3): String;
// запись в outFile
...
implementation uses LazLoggerBase, LazTracer;
...
function Fmtln(Params:Array of Const; C:Integer = 3): AnsiString;
begin
 Result := Fmt(Params, C) + #13#10;
end;
