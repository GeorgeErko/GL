...
type
  ...
  { TChildSpeedButtonForm }

  TChildSpeedButtonForm = class(TForm)
    btnCancel: TButton;
    btnOK: TButton;
    ECaption: TEdit;
    EHint: TEdit;
...
function TChildSpeedButtonForm.Execute(var ACaption, AHint: String; var ABtnWidth: Integer): Boolean;
begin
